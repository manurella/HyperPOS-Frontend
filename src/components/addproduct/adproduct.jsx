          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <input
                ...
                className="w-full bg-gray-700 border border-gray-600 rounded-md shadow-sm py-2 px-3 text-zinc-900 focus:outline-none focus:ring-blue-500 focus:border-blue-500"
              />
            </div>
              ...
              <div>
                ...
                <div className="relative rounded-md shadow-sm">
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    className="block w-full pl-7 bg-gray-700 border border-gray-600 rounded-md py-2 px-3 text-zinc-900 focus:outline-none focus:ring-blue-500 focus:border-blue-500"
                    placeholder="0.00"
                  />
                </div>
              </div>
            ...
            <div>
              ...
              <div className="flex items-center">
                <label
                  htmlFor="photo"
                  className="cursor-pointer bg-gray-700 hover:bg-gray-600 border border-gray-600 rounded-md shadow-sm py-2 px-4 text-zinc-900 transition duration-150 ease-in-out"
                >
