      ...
      <header className="h-16 bg-white border-b border-zinc-200 flex items-center justify-between px-4 md:px-6 flex-shrink-0 z-20">
        ...
        <div className="flex items-center gap-3">
          <button
            ...
            className="p-2 rounded-lg text-zinc-500 hover:text-zinc-900 hover:bg-zinc-100 transition-colors lg:hidden"
            aria-label="Toggle sidebar"
          >
            <Menu size={20} />
          </button>

          <div className="hidden sm:flex items-center gap-1.5 text-zinc-400 text-sm">
            <Clock size={14} className="text-zinc-400" />
            <span className="font-medium text-zinc-600">{formattedTime}</span>
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            className="relative p-2 rounded-lg text-zinc-400 hover:text-zinc-900 hover:bg-zinc-100 transition-colors"
          ...
          >
            <div className="w-7 h-7 rounded-full bg-zinc-100 border border-zinc-200 flex items-center justify-center flex-shrink-0">
              <span className="text-zinc-900 text-xs font-bold uppercase">
                {user.username?.[0] || "U"}
              </span>
            </div>
            ...
            <LogOut size={15} className="text-zinc-400 group-hover:text-zinc-900 transition-colors" />
          </button>
            ...
            <div className="px-6 py-4 border-b border-zinc-100 bg-zinc-50/50">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-zinc-500 font-medium">Return to login screen</p>
                </div>
              </div>
            </div>
