      ...
      <div className="space-y-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 relative">
          <div>
            ...
            {suggestions.length > 0 && searchTerm && (
              <ul className="absolute z-20 left-0 right-1/2 bg-white border border-[#E8E5DC] rounded-xl shadow-lg mt-1 max-h-44 overflow-y-auto">
                {suggestions.map((product) => (
                  <li
                    key={product?.id}
                    className="cursor-pointer hover:bg-[#E6F0E1] px-3 py-2 flex justify-between text-sm text-[#1A1915]"
                    onClick={() => {
                  ...
                  >
                    ...
                    <span className="text-[#1A1915]/40">Stock: {product?.stock}</span>
                  </li>
                ))}
              </ul>
            )}
        ...
        {selectedProduct && (
          <div className="flex flex-wrap gap-2">
            <span className="bg-[#FAFAF7] border border-[#E8E5DC] rounded-lg px-3 py-2 text-xs font-medium text-[#1A1915]/80">
              Unit: <span className="text-[#1A1915] font-semibold">{unit}</span>
            </span>
            <span className="bg-[#FAFAF7] border border-[#E8E5DC] rounded-lg px-3 py-2 text-xs font-medium text-[#1A1915]/80">
              Cost: <span className="text-[#1A1915] font-semibold">Rs. {unitCost?.toFixed(2)}</span>
            </span>
            <span className="bg-[#FAFAF7] border border-[#E8E5DC] rounded-lg px-3 py-2 text-xs font-medium text-[#1A1915]/80">
              Discount: <span className="text-[#1A1915] font-semibold">{discount}%</span>
            </span>
            <span className="bg-[#E6F0E1] border border-[rgba(79,122,63,0.3)] rounded-lg px-3 py-2 text-xs font-medium text-[#4F7A3F]">
