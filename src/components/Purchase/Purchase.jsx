...
const Purchase = () => {
  ...
  return (
    <div className="space-y-5">
        ...
        {/* Page title */}
        <div>
          <h1 className="font-sans text-[30px] font-bold text-[#1A1915] tracking-[-0.02em]">Purchase / GRN</h1>
          <p className="text-[13px] text-[#8C8A82] mt-0.5">Create and manage goods received notes.</p>
        </div>
