    ...
    <div className="bg-white border border-[#E8E5DC] rounded-xl p-5">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div className="flex items-center gap-3">
          <span className="text-[#5C5A54] font-medium">Grand Total:</span>
          <span className="text-2xl sm:text-3xl font-bold text-[#1A1915]">Rs. {grandTotal.toFixed(2)}</span>
        </div>
        <div className="flex gap-4 flex-wrap">
          ...
          <div>
            ...
            <input
              ...
              className="pos-input w-36 bg-[#FAFAF7] text-[#1A1915]/80"
            />
          </div>
        </div>
      </div>
